#pragma checksum "F:\infonetpos\infonetpos-gui\Infonet.CStoreCommander.UI\Controls\AckrooAccoutBalance.xaml" "{406ea660-64cf-4c82-b6f0-42d48172a799}" "727402C67CDCC710045BFFC01FCAD907"
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace Infonet.CStoreCommander.UI.Controls
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
            ...
            IAckrooAccoutBalance_Bindings
        {
            ...
            {
                if (lineNumber == 179 && columnNumber == 56)
                {
                    isobj2ItemsSourceDisabled = true;
                }
                else if (lineNumber == 188 && columnNumber == 39)
                {
                ...
                else if (lineNumber == 159 && columnNumber == 51)
                {
                ...
                else if (lineNumber == 143 && columnNumber == 73)
                {
                    isobj5CommandDisabled = true;
                }
                else if (lineNumber == 121 && columnNumber == 73)
                {
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                ...
                if (newDataRoot != null)
                {
                    this.dataRoot = (global::Infonet.CStoreCommander.UI.Controls.AckrooAccoutBalance)newDataRoot;
                    return true;
                }
                return false;
            }
            ...
            private void Update_AckrooTenderVM_BalanceItems(global::System.Collections.Generic.List<global::Infonet.CStoreCommander.EntityLayer.Entities.Ackroo.AckrooItem> obj, int phase)
            {
                ...
                {
                    // Controls\AckrooAccoutBalance.xaml line 179
            ...
            private void Update_AckrooTenderVM_NotifyInfo(global::System.String obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED | DATA_CHANGED)) != 0)
                {
                    // Controls\AckrooAccoutBalance.xaml line 150
            ...
            private void Update_AckrooTenderVM_BalanceOKCommand(global::GalaSoft.MvvmLight.Command.RelayCommand obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED | DATA_CHANGED)) != 0)
                {
                    // Controls\AckrooAccoutBalance.xaml line 158
            ...
            private void Update_AckrooTenderVM_InvokeKeyboardCommand(global::GalaSoft.MvvmLight.Command.RelayCommand obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED | DATA_CHANGED)) != 0)
                {
                    // Controls\AckrooAccoutBalance.xaml line 143
                    ...
                    // Controls\AckrooAccoutBalance.xaml line 121
            ...
            private void Update_AckrooTenderVM_OutStandingBalance(global::System.String obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED | DATA_CHANGED)) != 0)
                {
                    // Controls\AckrooAccoutBalance.xaml line 102
            ...
            private void UpdateTwoWay_2_SelectedItem()
            {
                if (this.initialized)
                {
                    ...
                    {
                        if (this.dataRoot.AckrooTenderVM != null)
                        {
            ...
            {
                private global::System.WeakReference<AckrooAccoutBalance_obj1_Bindings> weakRefToBindingObj; 
                ...
                public AckrooAccoutBalance_obj1_Bindings TryGetBindingObject()
                {
                    AckrooAccoutBalance_obj1_Bindings bindingObject = null;
                ...
                {
                    AckrooAccoutBalance_obj1_Bindings bindings = TryGetBindingObject();
                    if (bindings != null)
                    {
        ...
        public global::Windows.UI.Xaml.Markup.IComponentConnector GetBindingConnector(int connectionId, object target)
        {
            ...
            switch(connectionId)
            {
            case 1: // Controls\AckrooAccoutBalance.xaml line 1
                {                    
