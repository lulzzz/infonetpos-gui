#pragma checksum "F:\infonetpos\infonetpos-gui\Infonet.CStoreCommander.UI\View\Ackroo\CardOperations\AckrooSellCarwashUnits.xaml" "{406ea660-64cf-4c82-b6f0-42d48172a799}" "A2C5CB590A0C71AF0F823A8879DE68EE"
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace Infonet.CStoreCommander.UI.View.Ackroo
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
            ...
            IAckrooSellCarwashUnits_Bindings
        {
            ...
            private static bool isobj7EnterPressedCommandDisabled = false;
            ...
            {
                if (lineNumber == 158 && columnNumber == 43)
                {
                ...
                else if (lineNumber == 102 && columnNumber == 38)
                {
                    isobj7EnterPressedCommandDisabled = true;
                }
            ...
            private void Update_AKVM_AmountCommand(global::GalaSoft.MvvmLight.Command.RelayCommand<global::System.Object> obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED | DATA_CHANGED)) != 0)
                {
                    ...
                    if (!isobj7EnterPressedCommandDisabled)
                    {
