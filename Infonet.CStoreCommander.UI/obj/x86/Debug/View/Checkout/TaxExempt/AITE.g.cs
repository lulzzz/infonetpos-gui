#pragma checksum "F:\infonetpos\infonetpos-gui\Infonet.CStoreCommander.UI\View\Checkout\TaxExempt\AITE.xaml" "{406ea660-64cf-4c82-b6f0-42d48172a799}" "F18216272861435BFCC8401CB343CBEB"
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace Infonet.CStoreCommander.UI.View.Checkout.TaxExempt
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
            ...
            IAITE_Bindings
        {
            ...
            {
                if (lineNumber == 34 && columnNumber == 38)
                {
                    isobj2PreviousFrameDisabled = true;
                }
                else if (lineNumber == 124 && columnNumber == 39)
                {
                    isobj3IsEnabledDisabled = true;
                }
                else if (lineNumber == 125 && columnNumber == 39)
                {
