        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
            ...
            IOverrideLimit_Bindings
        {
            ...
            public void Disable(int lineNumber, int columnNumber)
            {
                ...
                else if (lineNumber == 83 && columnNumber == 30)
                {
                    isobj7TextDisabled = true;
                }
                else if (lineNumber == 84 && columnNumber == 30)
                {
                    isobj7BackCommandDisabled = true;
                }
                else if (lineNumber == 207 && columnNumber == 20)
                {
                    isobj8TextDisabled = true;
                }
                else if (lineNumber == 209 && columnNumber == 20)
                {
                    isobj8VisibilityDisabled = true;
                }
                else if (lineNumber == 212 && columnNumber == 15)
                {
                    isobj9VisibilityDisabled = true;
                }
                else if (lineNumber == 277 && columnNumber == 15)
                {
                    isobj10VisibilityDisabled = true;
                }
                else if (lineNumber == 286 && columnNumber == 37)
                {
                    isobj11VisibilityDisabled = true;
                }
                else if (lineNumber == 287 && columnNumber == 37)
                {
                ...
                else if (lineNumber == 297 && columnNumber == 37)
                {
                ...
                else if (lineNumber == 269 && columnNumber == 26)
                {
                    isobj14IsEnabledDisabled = true;
                }
                else if (lineNumber == 246 && columnNumber == 27)
                {
                    isobj15ItemsSourceDisabled = true;
                }
                else if (lineNumber == 247 && columnNumber == 27)
                {
                    isobj15IsEnabledDisabled = true;
                }
                else if (lineNumber == 253 && columnNumber == 53)
                {
                    isobj16CommandDisabled = true;
                }
                else if (lineNumber == 254 && columnNumber == 53)
                {
                    isobj16CommandParameterDisabled = true;
                }
                else if (lineNumber == 227 && columnNumber == 26)
                {
