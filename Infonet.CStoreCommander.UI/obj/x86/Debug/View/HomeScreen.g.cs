#pragma checksum "F:\infonetpos\infonetpos-gui\Infonet.CStoreCommander.UI\View\HomeScreen.xaml" "{406ea660-64cf-4c82-b6f0-42d48172a799}" "614B5887FD85EFD053FEF1D33D23120F"
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace Infonet.CStoreCommander.UI.View
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
            ...
            IHomeScreen_Bindings
        {
            ...
            private static bool isobj9OpenPaneLengthDisabled = false;
            ...
            private static bool isobj24IsOpenDisabled = false;
            ...
            private static bool isobj32PasswordRevealModeDisabled = false;
            private static bool isobj33CancelCommandDisabled = false;
            private static bool isobj34HeadingDisabled = false;
            private static bool isobj34CancelCommandDisabled = false;
            private static bool isobj35HeadingDisabled = false;
            private static bool isobj35ItemClickedDisabled = false;
            private static bool isobj36MessageDisabled = false;
            private static bool isobj36ContinueDisabled = false;
            private static bool isobj36ButtonBackgroundColorDisabled = false;
            private static bool isobj36TitleDisabled = false;
            private static bool isobj37HeadingTextDisabled = false;
            private static bool isobj37FirstButtonBottomBackgroundColorDisabled = false;
            private static bool isobj37SecondButtonBottomBackgroundColorDisabled = false;
            private static bool isobj37FirstButtonTextDisabled = false;
            private static bool isobj37DescriptionDisabled = false;
            private static bool isobj37SecondButtonTextDisabled = false;
            private static bool isobj37ThirdButtonTextDisabled = false;
            private static bool isobj37IsThirdButtonVisibleDisabled = false;
            private static bool isobj37ThirdButtonBottomBackgroundColorDisabled = false;
            ...
            private static bool isobj41ContentDisabled = false;
            ...
            private static bool isobj55IsEnabledDisabled = false;
            ...
            {
                if (lineNumber == 135 && columnNumber == 53)
                {
                ...
                else if (lineNumber == 109 && columnNumber == 53)
                {
                    isobj5ValueDisabled = true;
                }
                else if (lineNumber == 98 && columnNumber == 53)
                {
                ...
                else if (lineNumber == 161 && columnNumber == 15)
                {
                    isobj8VisibilityDisabled = true;
                }
                else if (lineNumber == 335 && columnNumber == 20)
                {
                    isobj9VisibilityDisabled = true;
                }
                else if (lineNumber == 339 && columnNumber == 20)
                {
                    isobj9IsPaneOpenDisabled = true;
                }
                else if (lineNumber == 340 && columnNumber == 20)
                {
                    isobj9OpenPaneLengthDisabled = true;
                }
                else if (lineNumber == 596 && columnNumber == 20)
                {
                    isobj11IsOpenDisabled = true;
                }
                else if (lineNumber == 611 && columnNumber == 20)
                {
                    isobj12IsOpenDisabled = true;
                }
                else if (lineNumber == 618 && columnNumber == 20)
                {
                    isobj13IsOpenDisabled = true;
                }
                else if (lineNumber == 629 && columnNumber == 20)
                {
                    isobj14IsOpenDisabled = true;
                }
                else if (lineNumber == 638 && columnNumber == 20)
                {
                    isobj15IsOpenDisabled = true;
                }
                else if (lineNumber == 644 && columnNumber == 20)
                {
                    isobj16IsOpenDisabled = true;
                }
                else if (lineNumber == 650 && columnNumber == 20)
                {
                    isobj17IsOpenDisabled = true;
                }
                else if (lineNumber == 656 && columnNumber == 20)
                {
                    isobj18IsOpenDisabled = true;
                }
                else if (lineNumber == 662 && columnNumber == 20)
                {
                    isobj19IsOpenDisabled = true;
                }
                else if (lineNumber == 669 && columnNumber == 20)
                {
                    isobj20IsOpenDisabled = true;
                }
                else if (lineNumber == 677 && columnNumber == 20)
                {
                    isobj21IsOpenDisabled = true;
                }
                else if (lineNumber == 683 && columnNumber == 20)
                {
                    isobj22IsOpenDisabled = true;
                }
                else if (lineNumber == 690 && columnNumber == 20)
                {
                    isobj23IsOpenDisabled = true;
                }
                else if (lineNumber == 697 && columnNumber == 20)
                {
                    isobj24IsOpenDisabled = true;
                }
                else if (lineNumber == 703 && columnNumber == 20)
                {
                    isobj25IsOpenDisabled = true;
                }
                else if (lineNumber == 709 && columnNumber == 20)
                {
                    isobj26IsOpenDisabled = true;
                }
                else if (lineNumber == 715 && columnNumber == 20)
                {
                    isobj27IsOpenDisabled = true;
                }
                else if (lineNumber == 720 && columnNumber == 20)
                {
                    isobj28IsOpenDisabled = true;
                }
                else if (lineNumber == 725 && columnNumber == 20)
                {
                    isobj29IsOpenDisabled = true;
                }
                else if (lineNumber == 730 && columnNumber == 20)
                {
                    isobj30IsOpenDisabled = true;
                }
                else if (lineNumber == 735 && columnNumber == 20)
                {
                    isobj31IsOpenDisabled = true;
                }
                else if (lineNumber == 692 && columnNumber == 44)
                {
                    isobj32PasswordRevealModeDisabled = true;
                }
                else if (lineNumber == 685 && columnNumber == 39)
                {
                    isobj33CancelCommandDisabled = true;
                }
                else if (lineNumber == 672 && columnNumber == 40)
                {
                    isobj34HeadingDisabled = true;
                }
                else if (lineNumber == 673 && columnNumber == 40)
                {
                    isobj34CancelCommandDisabled = true;
                }
                else if (lineNumber == 632 && columnNumber == 38)
                {
                    isobj35HeadingDisabled = true;
                }
                else if (lineNumber == 633 && columnNumber == 38)
                {
                    isobj35ItemClickedDisabled = true;
                }
                else if (lineNumber == 621 && columnNumber == 45)
                {
                    isobj36MessageDisabled = true;
                }
                else if (lineNumber == 622 && columnNumber == 45)
                {
                    isobj36ContinueDisabled = true;
                }
                else if (lineNumber == 623 && columnNumber == 45)
                {
                    isobj36ButtonBackgroundColorDisabled = true;
                }
                else if (lineNumber == 624 && columnNumber == 45)
                {
                    isobj36TitleDisabled = true;
                }
                else if (lineNumber == 597 && columnNumber == 47)
                {
                    isobj37HeadingTextDisabled = true;
                }
                else if (lineNumber == 600 && columnNumber == 47)
                {
                    isobj37FirstButtonBottomBackgroundColorDisabled = true;
                }
                else if (lineNumber == 601 && columnNumber == 47)
                {
                    isobj37SecondButtonBottomBackgroundColorDisabled = true;
                }
                else if (lineNumber == 602 && columnNumber == 47)
                {
                    isobj37FirstButtonTextDisabled = true;
                }
                else if (lineNumber == 603 && columnNumber == 47)
                {
                    isobj37DescriptionDisabled = true;
                }
                else if (lineNumber == 604 && columnNumber == 47)
                {
                    isobj37SecondButtonTextDisabled = true;
                }
                else if (lineNumber == 605 && columnNumber == 47)
                {
                    isobj37ThirdButtonTextDisabled = true;
                }
                else if (lineNumber == 606 && columnNumber == 47)
                {
                    isobj37IsThirdButtonVisibleDisabled = true;
                }
                else if (lineNumber == 607 && columnNumber == 47)
                {
                    isobj37ThirdButtonBottomBackgroundColorDisabled = true;
                }
                else if (lineNumber == 498 && columnNumber == 33)
                {
                    isobj38IsEnabledDisabled = true;
                }
                else if (lineNumber == 499 && columnNumber == 33)
                {
                ...
                else if (lineNumber == 535 && columnNumber == 33)
                {
                    isobj40VisibilityDisabled = true;
                }
                else if (lineNumber == 547 && columnNumber == 33)
                {
                    isobj41ContentDisabled = true;
                }
                else if (lineNumber == 556 && columnNumber == 33)
                {
                    isobj42VisibilityDisabled = true;
                }
                else if (lineNumber == 561 && columnNumber == 67)
                {
                    isobj43CommandDisabled = true;
                }
                else if (lineNumber == 543 && columnNumber == 38)
                {
                    isobj45TextDisabled = true;
                }
                else if (lineNumber == 529 && columnNumber == 67)
                {
                    isobj46CommandDisabled = true;
                }
                else if (lineNumber == 517 && columnNumber == 67)
                {
                    isobj47CommandDisabled = true;
                }
                else if (lineNumber == 503 && columnNumber == 67)
                {
                    isobj48CommandDisabled = true;
                }
                else if (lineNumber == 489 && columnNumber == 67)
                {
                    isobj49CommandDisabled = true;
                }
                else if (lineNumber == 478 && columnNumber == 44)
                {
                ...
                else if (lineNumber == 364 && columnNumber == 33)
                {
                    isobj53IsEnabledDisabled = true;
                }
                else if (lineNumber == 377 && columnNumber == 33)
                {
                    isobj54IsEnabledDisabled = true;
                }
                else if (lineNumber == 389 && columnNumber == 33)
                {
                    isobj55IsEnabledDisabled = true;
                }
                else if (lineNumber == 403 && columnNumber == 33)
                {
                    isobj56IsEnabledDisabled = true;
                }
                else if (lineNumber == 416 && columnNumber == 34)
                {
                    isobj57IsEnabledDisabled = true;
                }
                else if (lineNumber == 430 && columnNumber == 33)
                {
                    isobj58VisibilityDisabled = true;
                }
                else if (lineNumber == 436 && columnNumber == 67)
                {
                    isobj59CommandDisabled = true;
                }
                else if (lineNumber == 422 && columnNumber == 67)
                {
                    isobj60CommandDisabled = true;
                }
                else if (lineNumber == 409 && columnNumber == 67)
                {
                    isobj61CommandDisabled = true;
                }
                else if (lineNumber == 396 && columnNumber == 67)
                {
                    isobj62CommandDisabled = true;
                }
                else if (lineNumber == 383 && columnNumber == 67)
                {
                    isobj63CommandDisabled = true;
                }
                else if (lineNumber == 370 && columnNumber == 67)
                {
                    isobj64CommandDisabled = true;
                }
                else if (lineNumber == 169 && columnNumber == 23)
                {
                ...
                {
                    isobj71IsEnabledDisabled = true;
                }
                else if (lineNumber == 315 && columnNumber == 25)
                {
                    isobj72VisibilityDisabled = true;
                }
                else if (lineNumber == 321 && columnNumber == 59)
                {
                    isobj73CommandDisabled = true;
                }
                else if (lineNumber == 295 && columnNumber == 59)
                {
                    isobj74CommandDisabled = true;
                }
                else if (lineNumber == 283 && columnNumber == 59)
                {
                    isobj75CommandDisabled = true;
                }
                else if (lineNumber == 260 && columnNumber == 29)
                {
                    isobj76ContentDisabled = true;
                }
            ...
            private void Update_HomeScreenVM_Width(global::System.Double obj, int phase)
            {
                ...
                {
                    // View\HomeScreen.xaml line 335
                    if (!isobj9OpenPaneLengthDisabled)
                    {
            ...
            private void Update_HomeScreenVM_PopupService_PasswordRevelMode(global::System.Boolean obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED | DATA_CHANGED)) != 0)
                {
                    ...
                    if (!isobj32PasswordRevealModeDisabled)
                    {
            ...
            private void Update_HomeScreenVM_ClosePumpOptionsPopupCommand(global::GalaSoft.MvvmLight.Command.RelayCommand obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED | DATA_CHANGED)) != 0)
                {
                    ...
                    if (!isobj33CancelCommandDisabled)
                    {
            ...
            private void Update_HomeScreenVM_PopupService_CloseCommand(global::System.Windows.Input.ICommand obj, int phase)
            {
                ...
                {
                    // View\HomeScreen.xaml line 670
                    if (!isobj34CancelCommandDisabled)
                    {
            ...
            private void Update_HomeScreenVM_PopupService_OkButtonColor(global::Windows.UI.Xaml.Media.SolidColorBrush obj, int phase)
            {
                ...
                {
                    // View\HomeScreen.xaml line 619
                    if (!isobj36ButtonBackgroundColorDisabled)
                    {
            ...
            private void Update_HomeScreenVM_PopupService_YesButtonColor(global::Windows.UI.Xaml.Media.SolidColorBrush obj, int phase)
            {
                ...
                {
                    // View\HomeScreen.xaml line 597
                    if (!isobj37FirstButtonBottomBackgroundColorDisabled)
                    {
            ...
            private void Update_HomeScreenVM_PopupService_NoButtonColor(global::Windows.UI.Xaml.Media.SolidColorBrush obj, int phase)
            {
                ...
                {
                    // View\HomeScreen.xaml line 597
                    if (!isobj37SecondButtonBottomBackgroundColorDisabled)
                    {
            ...
            private void Update_HomeScreenVM_PopupService_YesButtonText(global::System.String obj, int phase)
            {
                ...
                {
                    // View\HomeScreen.xaml line 597
                    if (!isobj37FirstButtonTextDisabled)
                    {
            ...
            private void Update_HomeScreenVM_PopupService_NoButtonText(global::System.String obj, int phase)
            {
                ...
                {
                    // View\HomeScreen.xaml line 597
                    if (!isobj37SecondButtonTextDisabled)
                    {
            ...
            private void Update_HomeScreenVM_PopupService_ThirdButtonText(global::System.String obj, int phase)
            {
                ...
                {
                    // View\HomeScreen.xaml line 597
                    if (!isobj37ThirdButtonTextDisabled)
                    {
            ...
            private void Update_HomeScreenVM_PopupService_IsThirdButtonVisible(global::System.Boolean obj, int phase)
            {
                ...
                {
                    // View\HomeScreen.xaml line 597
                    if (!isobj37IsThirdButtonVisibleDisabled)
                    {
            ...
            private void Update_HomeScreenVM_PopupService_ThirdButtonColor(global::Windows.UI.Xaml.Media.SolidColorBrush obj, int phase)
            {
                ...
                {
                    // View\HomeScreen.xaml line 597
                    if (!isobj37ThirdButtonBottomBackgroundColorDisabled)
                    {
