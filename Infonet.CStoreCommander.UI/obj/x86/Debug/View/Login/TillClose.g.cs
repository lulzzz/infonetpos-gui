#pragma checksum "F:\infonetpos\infonetpos-gui\Infonet.CStoreCommander.UI\View\Login\TillClose.xaml" "{406ea660-64cf-4c82-b6f0-42d48172a799}" "0E6BC8EF198DB698C36AAB313178C43D"
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace Infonet.CStoreCommander.UI.View.Login
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
            ...
            ITillClose_Bindings
        {
            ...
            private static bool isobj6ContinueDisabled = false;
            private static bool isobj6ButtonBackgroundColorDisabled = false;
            private static bool isobj6TitleDisabled = false;
            private static bool isobj7HeadingTextDisabled = false;
            private static bool isobj7FirstButtonBottomBackgroundColorDisabled = false;
            private static bool isobj7SecondButtonBottomBackgroundColorDisabled = false;
            private static bool isobj7FirstButtonTextDisabled = false;
            private static bool isobj7DescriptionDisabled = false;
            private static bool isobj7SecondButtonTextDisabled = false;
            private static bool isobj7ThirdButtonTextDisabled = false;
            private static bool isobj7IsThirdButtonVisibleDisabled = false;
            private static bool isobj7ThirdButtonBottomBackgroundColorDisabled = false;
            ...
            private static bool isobj21KeyUpCommandDisabled = false;
            ...
            public void Disable(int lineNumber, int columnNumber)
            {
                ...
                else if (lineNumber == 450 && columnNumber == 20)
                {
                    isobj4IsOpenDisabled = true;
                }
                else if (lineNumber == 466 && columnNumber == 20)
                {
                    isobj5IsOpenDisabled = true;
                }
                else if (lineNumber == 469 && columnNumber == 45)
                {
                    isobj6MessageDisabled = true;
                }
                else if (lineNumber == 470 && columnNumber == 45)
                {
                    isobj6ContinueDisabled = true;
                }
                else if (lineNumber == 471 && columnNumber == 45)
                {
                    isobj6ButtonBackgroundColorDisabled = true;
                }
                else if (lineNumber == 472 && columnNumber == 45)
                {
                    isobj6TitleDisabled = true;
                }
                else if (lineNumber == 451 && columnNumber == 43)
                {
                    isobj7HeadingTextDisabled = true;
                }
                else if (lineNumber == 454 && columnNumber == 47)
                {
                    isobj7FirstButtonBottomBackgroundColorDisabled = true;
                }
                else if (lineNumber == 455 && columnNumber == 47)
                {
                    isobj7SecondButtonBottomBackgroundColorDisabled = true;
                }
                else if (lineNumber == 456 && columnNumber == 47)
                {
                    isobj7FirstButtonTextDisabled = true;
                }
                else if (lineNumber == 457 && columnNumber == 47)
                {
                    isobj7DescriptionDisabled = true;
                }
                else if (lineNumber == 458 && columnNumber == 47)
                {
                    isobj7SecondButtonTextDisabled = true;
                }
                else if (lineNumber == 459 && columnNumber == 47)
                {
                    isobj7ThirdButtonTextDisabled = true;
                }
                else if (lineNumber == 460 && columnNumber == 47)
                {
                    isobj7IsThirdButtonVisibleDisabled = true;
                }
                else if (lineNumber == 461 && columnNumber == 47)
                {
                    isobj7ThirdButtonBottomBackgroundColorDisabled = true;
                }
                ...
                else if (lineNumber == 214 && columnNumber == 32)
                {
                    isobj10ItemsSourceDisabled = true;
                }
                else if (lineNumber == 215 && columnNumber == 32)
                {
                    isobj10SelectedItemDisabled = true;
                }
                else if (lineNumber == 216 && columnNumber == 32)
                {
                    isobj10VisibilityDisabled = true;
                }
                else if (lineNumber == 270 && columnNumber == 32)
                {
                    isobj11ItemsSourceDisabled = true;
                }
                else if (lineNumber == 271 && columnNumber == 32)
                {
                    isobj11SelectedItemDisabled = true;
                }
                else if (lineNumber == 272 && columnNumber == 32)
                {
                    isobj11VisibilityDisabled = true;
                }
                else if (lineNumber == 309 && columnNumber == 32)
                {
                    isobj12SelectedItemDisabled = true;
                }
                else if (lineNumber == 310 && columnNumber == 32)
                {
                ...
                else if (lineNumber == 364 && columnNumber == 20)
                {
                    isobj13VisibilityDisabled = true;
                }
                else if (lineNumber == 406 && columnNumber == 39)
                {
                    isobj14IsEnabledDisabled = true;
                }
                else if (lineNumber == 407 && columnNumber == 39)
                {
                    isobj14VisibilityDisabled = true;
                }
                else if (lineNumber == 408 && columnNumber == 39)
                {
                    isobj14CommandDisabled = true;
                }
                else if (lineNumber == 420 && columnNumber == 39)
                {
                    isobj15IsEnabledDisabled = true;
                }
                else if (lineNumber == 422 && columnNumber == 39)
                {
                    isobj15CommandDisabled = true;
                }
                else if (lineNumber == 434 && columnNumber == 19)
                {
                    isobj16VisibilityDisabled = true;
                }
                else if (lineNumber == 443 && columnNumber == 26)
                {
                    isobj17TextDisabled = true;
                }
                else if (lineNumber == 396 && columnNumber == 43)
                {
                    isobj18CommandDisabled = true;
                }
                else if (lineNumber == 388 && columnNumber == 36)
                {
                ...
                {
                    isobj21KeyUpCommandDisabled = true;
                }
                else if (lineNumber == 119 && columnNumber == 50)
                {
            ...
            private void Update_CloseTillVM_PopupService_OkButtonColor(global::Windows.UI.Xaml.Media.SolidColorBrush obj, int phase)
            {
                ...
                {
                    // View\Login\TillClose.xaml line 467
                    if (!isobj6ButtonBackgroundColorDisabled)
                    {
            ...
            private void Update_CloseTillVM_PopupService_YesButtonColor(global::Windows.UI.Xaml.Media.SolidColorBrush obj, int phase)
            {
                ...
                {
                    // View\Login\TillClose.xaml line 451
                    if (!isobj7FirstButtonBottomBackgroundColorDisabled)
                    {
            ...
            private void Update_CloseTillVM_PopupService_NoButtonColor(global::Windows.UI.Xaml.Media.SolidColorBrush obj, int phase)
            {
                ...
                {
                    // View\Login\TillClose.xaml line 451
                    if (!isobj7SecondButtonBottomBackgroundColorDisabled)
                    {
            ...
            private void Update_CloseTillVM_PopupService_YesButtonText(global::System.String obj, int phase)
            {
                ...
                {
                    // View\Login\TillClose.xaml line 451
                    if (!isobj7FirstButtonTextDisabled)
                    {
            ...
            private void Update_CloseTillVM_PopupService_NoButtonText(global::System.String obj, int phase)
            {
                ...
                {
                    // View\Login\TillClose.xaml line 451
                    if (!isobj7SecondButtonTextDisabled)
                    {
            ...
            private void Update_CloseTillVM_PopupService_ThirdButtonText(global::System.String obj, int phase)
            {
                ...
                {
                    // View\Login\TillClose.xaml line 451
                    if (!isobj7ThirdButtonTextDisabled)
                    {
            ...
            private void Update_CloseTillVM_PopupService_IsThirdButtonVisible(global::System.Boolean obj, int phase)
            {
                ...
                {
                    // View\Login\TillClose.xaml line 451
                    if (!isobj7IsThirdButtonVisibleDisabled)
                    {
            ...
            private void Update_CloseTillVM_PopupService_ThirdButtonColor(global::Windows.UI.Xaml.Media.SolidColorBrush obj, int phase)
            {
                ...
                {
                    // View\Login\TillClose.xaml line 451
                    if (!isobj7ThirdButtonBottomBackgroundColorDisabled)
                    {
            ...
            private void Update_CloseTillVM_TenderValueChangedCommand(global::GalaSoft.MvvmLight.Command.RelayCommand obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED | DATA_CHANGED)) != 0)
                {
                    ...
                    if (!isobj21KeyUpCommandDisabled)
                    {
