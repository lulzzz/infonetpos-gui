#pragma checksum "F:\infonetpos\infonetpos-gui\Infonet.CStoreCommander.UI\View\PSInet\PSInetOptions\PS.xaml" "{406ea660-64cf-4c82-b6f0-42d48172a799}" "5C3EEAEEC83522EA7E9EE6B49697D260"
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace Infonet.CStoreCommander.UI.View.PSInet.PSInetOptions
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
            ...
            IPS_Bindings
        {
            ...
            {
                if (lineNumber == 45 && columnNumber == 38)
                {
                ...
                else if (lineNumber == 66 && columnNumber == 43)
                {
                    isobj4CommandDisabled = true;
                }
                else if (lineNumber == 76 && columnNumber == 77)
                {
            ...
            public void Connect(int connectionId, global::System.Object target)
            {
                switch(connectionId)
                {
                    case 2: // View\PSInet\PSInetOptions\PS.xaml line 39
                        this.obj2 = (global::MyToolkit.Extended.Controls.CustomTextBox)target;
                        break;
                    case 3: // View\PSInet\PSInetOptions\PS.xaml line 50
                        this.obj3 = (global::Windows.UI.Xaml.Controls.TextBlock)target;
                        break;
                    case 4: // View\PSInet\PSInetOptions\PS.xaml line 63
                        this.obj4 = (global::Infonet.CStoreCommander.ControlLib.GenericButton)target;
                        break;
                    case 5: // View\PSInet\PSInetOptions\PS.xaml line 76
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                ...
                if (newDataRoot != null)
                {
                    this.dataRoot = (global::Infonet.CStoreCommander.UI.View.PSInet.PSInetOptions.PS)newDataRoot;
                    return true;
                }
                return false;
            }
            ...
            private void Update_PaymentSourceVM_CardNumberCommand(global::GalaSoft.MvvmLight.Command.RelayCommand<global::System.Object> obj, int phase)
            {
                ...
                {
                    // View\PSInet\PSInetOptions\PS.xaml line 39
            ...
            private void Update_PaymentSourceVM_AmountLabel(global::System.String obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED | DATA_CHANGED)) != 0)
                {
                    // View\PSInet\PSInetOptions\PS.xaml line 50
            ...
            private void Update_PaymentSourceVM_CardActivationCommand(global::GalaSoft.MvvmLight.Command.RelayCommand obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED | DATA_CHANGED)) != 0)
                {
                    // View\PSInet\PSInetOptions\PS.xaml line 63
            ...
            private void Update_PaymentSourceVM_ProdInfo(global::System.String obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED | DATA_CHANGED)) != 0)
                {
                    // View\PSInet\PSInetOptions\PS.xaml line 76
            ...
            {
                private global::System.WeakReference<PS_obj1_Bindings> weakRefToBindingObj; 
                ...
                public PS_obj1_Bindings TryGetBindingObject()
                {
                    PS_obj1_Bindings bindingObject = null;
                ...
                {
                    PS_obj1_Bindings bindings = TryGetBindingObject();
                    if (bindings != null)
                    {
        ...
        public global::Windows.UI.Xaml.Markup.IComponentConnector GetBindingConnector(int connectionId, object target)
        {
            ...
            switch(connectionId)
            {
            case 1: // View\PSInet\PSInetOptions\PS.xaml line 1
                {                    
