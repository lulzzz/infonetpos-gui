...
namespace Infonet.CStoreCommander.UI.View.PumpOptions.Propane
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
            ...
            IPropaneGrade_Bindings
        {
            ...
            private static bool isobj5IsHitTestVisibleDisabled = false;
            ...
            {
                if (lineNumber == 143 && columnNumber == 35)
                {
                ...
                else if (lineNumber == 134 && columnNumber == 24)
                {
                    isobj4VisibilityDisabled = true;
                }
                else if (lineNumber == 136 && columnNumber == 24)
                {
                    isobj4TextDisabled = true;
                }
                else if (lineNumber == 110 && columnNumber == 36)
                {
                    isobj5IsHitTestVisibleDisabled = true;
                }
            ...
            private void Update_PropaneGradeVM_IsAmountEditTrue(global::System.Boolean obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED | DATA_CHANGED)) != 0)
                {
                    ...
                    if (!isobj5IsHitTestVisibleDisabled)
                    {
