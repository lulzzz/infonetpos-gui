#pragma checksum "F:\infonetpos\infonetpos-gui\Infonet.CStoreCommander.UI\View\Sale\SaleGrid.xaml" "{406ea660-64cf-4c82-b6f0-42d48172a799}" "FEC8D3FDB1C91BDEDA1129170ABB970B"
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace Infonet.CStoreCommander.UI.View.Sale
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
            ...
            ISaleGrid_Bindings
        {
            ...
            private static bool isobj2DeleteCommandDisabled = false;
            private static bool isobj2FocusOnEditableRowDisabled = false;
            ...
            private static bool isobj14FocusOnEditableRowDisabled = false;
            ...
            {
                if (lineNumber == 60 && columnNumber == 28)
                {
                    isobj2ItemsSourceDisabled = true;
                }
                else if (lineNumber == 64 && columnNumber == 28)
                {
                    isobj2DeleteCommandDisabled = true;
                }
                else if (lineNumber == 71 && columnNumber == 28)
                {
                    isobj2FocusOnEditableRowDisabled = true;
                }
                else if (lineNumber == 72 && columnNumber == 28)
                {
                    isobj2SelectedItemDisabled = true;
                }
                else if (lineNumber == 324 && columnNumber == 35)
                {
                    isobj3IsEnabledDisabled = true;
                }
                else if (lineNumber == 325 && columnNumber == 35)
                {
                    isobj3CommandDisabled = true;
                }
                else if (lineNumber == 309 && columnNumber == 39)
                {
                    isobj4CommandDisabled = true;
                }
                else if (lineNumber == 311 && columnNumber == 39)
                {
                ...
                else if (lineNumber == 315 && columnNumber == 39)
                {
                    isobj6CommandDisabled = true;
                }
                else if (lineNumber == 316 && columnNumber == 39)
                {
                    isobj6IsEnabledDisabled = true;
                }
                else if (lineNumber == 247 && columnNumber == 43)
                {
                    isobj7CommandDisabled = true;
                }
                else if (lineNumber == 253 && columnNumber == 43)
                {
                    isobj8CommandDisabled = true;
                }
                else if (lineNumber == 274 && columnNumber == 30)
                {
                    isobj9VisibilityDisabled = true;
                }
                else if (lineNumber == 278 && columnNumber == 30)
                {
                ...
                else if (lineNumber == 227 && columnNumber == 28)
                {
                ...
                else if (lineNumber == 208 && columnNumber == 32)
                {
                    isobj13TextDisabled = true;
                }
                else if (lineNumber == 83 && columnNumber == 46)
                {
                    isobj14FocusOnEditableRowDisabled = true;
                }
                else if (lineNumber == 118 && columnNumber == 46)
                {
            ...
            public void Connect(int connectionId, global::System.Object target)
            {
                switch(connectionId)
                {
                    case 2: // View\Sale\SaleGrid.xaml line 60
                        ...
                        // View\Sale\SaleGrid.xaml line 60
                        if (!isobj2DeleteCommandDisabled)
                        {
                            if (this.obj2 != null)
                            {
                        ...
                        // View\Sale\SaleGrid.xaml line 60
                        if (!isobj2FocusOnEditableRowDisabled)
                        {
                            if (this.obj2 != null)
                            {
                    ...
                    case 14: // View\Sale\SaleGrid.xaml line 75
                        ...
                        if (!isobj14FocusOnEditableRowDisabled)
                        {
                            if (this.obj14 != null)
                            {
