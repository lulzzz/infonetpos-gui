#pragma checksum "F:\infonetpos\infonetpos-gui\Infonet.CStoreCommander.UI\View\Stock\AddStock.xaml" "{406ea660-64cf-4c82-b6f0-42d48172a799}" "DC93C373ADC70ECE3422829E792D63DF"
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace Infonet.CStoreCommander.UI.View.Stock
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
            ...
            IAddStock_Bindings
        {
            ...
            {
                if (lineNumber == 173 && columnNumber == 35)
                {
            ...
            IAddStock_Bindings
        {
            ...
            // Static fields for each binding's enabled/disabled state
            private static bool isobj4BackCommandDisabled = false;
            ...
            public void Disable(int lineNumber, int columnNumber)
            {
                if (lineNumber == 117 && columnNumber == 30)
                {
                    isobj4BackCommandDisabled = true;
                }
                else if (lineNumber == 192 && columnNumber == 35)
                {
