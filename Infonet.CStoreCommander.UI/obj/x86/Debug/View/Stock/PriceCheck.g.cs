#pragma checksum "F:\infonetpos\infonetpos-gui\Infonet.CStoreCommander.UI\View\Stock\PriceCheck.xaml" "{406ea660-64cf-4c82-b6f0-42d48172a799}" "E73777A7FAC352594B12CB84C17E2C38"
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace Infonet.CStoreCommander.UI.View.Stock
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
            ...
            IPriceCheck_Bindings
        {
            ...
            {
                if (lineNumber == 594 && columnNumber == 53)
                {
            ...
            IPriceCheck_Bindings
        {
            ...
            private static bool isobj40SelectedDateDisabled = false;
            private static bool isobj41IsEnabledDisabled = false;
            private static bool isobj41SelectedDateDisabled = false;
            ...
            private static bool isobj46PasswordDisabled = false;
            ...
            public void Disable(int lineNumber, int columnNumber)
            {
                if (lineNumber == 169 && columnNumber == 30)
                {
                ...
                else if (lineNumber == 624 && columnNumber == 35)
                {
                    isobj13VisibilityDisabled = true;
                }
                else if (lineNumber == 625 && columnNumber == 35)
                {
                    isobj13IsEnabledDisabled = true;
                }
                else if (lineNumber == 626 && columnNumber == 35)
                {
                    isobj13CommandDisabled = true;
                }
                else if (lineNumber == 634 && columnNumber == 35)
                {
                    isobj14VisibilityDisabled = true;
                }
                else if (lineNumber == 635 && columnNumber == 35)
                {
                ...
                else if (lineNumber == 235 && columnNumber == 27)
                {
                    isobj15ItemsSourceDisabled = true;
                }
                else if (lineNumber == 236 && columnNumber == 27)
                {
                    isobj15SelectedIndexDisabled = true;
                }
                else if (lineNumber == 268 && columnNumber == 23)
                {
                    isobj16VisibilityDisabled = true;
                }
                else if (lineNumber == 294 && columnNumber == 23)
                {
                    isobj17VisibilityDisabled = true;
                }
                else if (lineNumber == 325 && columnNumber == 27)
                {
                ...
                else if (lineNumber == 336 && columnNumber == 27)
                {
                    isobj18SelectedIndexDisabled = true;
                }
                else if (lineNumber == 340 && columnNumber == 23)
                {
                    isobj19VisibilityDisabled = true;
                }
                else if (lineNumber == 348 && columnNumber == 27)
                {
                    isobj20VisibilityDisabled = true;
                }
                else if (lineNumber == 408 && columnNumber == 27)
                {
                    isobj21VisibilityDisabled = true;
                }
                else if (lineNumber == 507 && columnNumber == 27)
                {
                    isobj22VisibilityDisabled = true;
                }
                else if (lineNumber == 549 && columnNumber == 35)
                {
                    isobj23ItemsSourceDisabled = true;
                }
                else if (lineNumber == 604 && columnNumber == 31)
                {
                ...
                else if (lineNumber == 534 && columnNumber == 44)
                {
                    isobj29TextDisabled = true;
                }
                else if (lineNumber == 445 && columnNumber == 35)
                {
                    isobj30ItemsSourceDisabled = true;
                }
                else if (lineNumber == 493 && columnNumber == 31)
                {
                ...
                else if (lineNumber == 375 && columnNumber == 35)
                {
                    isobj36ItemsSourceDisabled = true;
                }
                else if (lineNumber == 361 && columnNumber == 40)
                {
                    isobj39TextDisabled = true;
                }
                else if (lineNumber == 303 && columnNumber == 58)
                {
                    isobj40IsEnabledDisabled = true;
                }
                else if (lineNumber == 306 && columnNumber == 58)
                {
                    isobj40SelectedDateDisabled = true;
                }
                else if (lineNumber == 313 && columnNumber == 58)
                {
                    isobj41IsEnabledDisabled = true;
                }
                else if (lineNumber == 318 && columnNumber == 58)
                {
                    isobj41SelectedDateDisabled = true;
                }
                else if (lineNumber == 287 && columnNumber == 30)
                {
                    isobj42TextDisabled = true;
                }
                else if (lineNumber == 252 && columnNumber == 45)
                {
                ...
                else if (lineNumber == 261 && columnNumber == 30)
                {
                    isobj44TextDisabled = true;
                }
                else if (lineNumber == 262 && columnNumber == 30)
                {
                    isobj44VisibilityDisabled = true;
                }
                else if (lineNumber == 207 && columnNumber == 24)
                {
                    isobj45TextDisabled = true;
                }
                else if (lineNumber == 180 && columnNumber == 26)
                {
                    isobj46PasswordDisabled = true;
                }
                else if (lineNumber == 183 && columnNumber == 26)
                {
                    isobj46IsEnabledDisabled = true;
                }
                else if (lineNumber == 188 && columnNumber == 55)
                {
            ...
            private void Update_PriceCheckVM_StockPriceModel_FromDate(global::System.DateTimeOffset obj, int phase)
            {
                ...
                {
                    // View\Stock\PriceCheck.xaml line 300
                    if (!isobj40SelectedDateDisabled)
                    {
            ...
            private void Update_PriceCheckVM_StockPriceModel_ToDate(global::System.DateTimeOffset obj, int phase)
            {
                ...
                {
                    // View\Stock\PriceCheck.xaml line 310
                    if (!isobj41SelectedDateDisabled)
                    {
